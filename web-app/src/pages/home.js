...
function Home(){
    ...
    <div id="bg">
        ...
        <form id="form" onSubmit={handleFormSubmit}>
            <div id="first-number">
                <label id="label"> Primeiro número <input className="input" type="number"  name="num1" id="num1" onChange={handleInputChange}   required /> </label>
            </div>
            <div id="second-number">
                <label id="label" > Segundo número <input  className="input" type="number" name="num2" id="num2" onChange={handleInputChange}   required /> </label>
            </div>
            <div>
